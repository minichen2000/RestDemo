...
import com.nokia.restful.ui_ctrl.server.model.Activities;
...
public class HistoryApiServiceImpl extends HistoryApiService {
    @Override
    public Response historyGet(Integer offset, Integer limit, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
